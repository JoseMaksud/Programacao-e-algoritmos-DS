...
while (op != 0) {
    ...
    op = parseInt(prompt("Digite um número inteiro ou 0 (zero) para sair"));
}
...
while(senhaDigitar != senhaCorreta) {
    ...
    senhaDigitar = parseInt(prompt("Digite sua senha: "));
}
...
while (op != 0) {
    ...
    soma += op;
    op = parseInt(prompt("Digite um número inteiro maior que 0  e  0 (zero) para sair"));
}
...
while (voto != 0) {
    ...
    voto = parseInt(prompt(instrucao));
}

var qtdeVotosTotais = qtdeVotosCandidato1 + qtdeVotosCandidato2 + qtdeVotosCandidato3 + qtdeVotosNulo + qtdeVotosBranco;
var porcentagemNulo = (qtdeVotosNulo / qtdeVotosTotais) * 100;
var porcentagemBranco = (qtdeVotosBranco / qtdeVotosTotais) * 100;

console.log("Quantidade votos Candidato Claudia Rodrigues: " + qtdeVotosCandidato1);
console.log("Quantidade votos Candidato Carlos Luz: " + qtdeVotosCandidato2);
console.log("Quantidade votos Candidato Neves Rocha: " + qtdeVotosCandidato3);
console.log("Porcentagem votos nulos: " + porcentagemNulo + "%");
console.log("Porcentagem votos brancos: " + porcentagemBranco + "%");


if (qtdeVotosCandidato1 > qtdeVotosCandidato2 && qtdeVotosCandidato1 > qtdeVotosCandidato3) {
    console.log("Candidato Claudia Rodrigues Venceu!");
} else if (qtdeVotosCandidato2 > qtdeVotosCandidato1 && qtdeVotosCandidato2 > qtdeVotosCandidato3) {
    console.log("Candidato Carlos Luz Venceu!");
} else if (qtdeVotosCandidato3 > qtdeVotosCandidato1 && qtdeVotosCandidato3 > qtdeVotosCandidato2) {
    console.log("Candidato Neves Rocha Venceu!");
} else {
